...
Install :
    ...
    wget --no-check-certificate https://raw.github.com/solehpolysas/3proxy/master/3proxyinstall.sh
...
Uninstall:
	...
	wget --no-check-certificate https://raw.github.com/solehpolysas/3proxy/master/3proxyuninstall.sh
